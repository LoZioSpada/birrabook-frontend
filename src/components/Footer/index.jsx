...
export default function Footer() {
    return (
        <div className={cn(styles.footBg, styles.textCenter, styles.pagination, 'w-100 mt-5')}>
                <Row xs={12} className="w-100 justify-content-center">
                    ...
                    >
                        ...
                        <div className="ms-1">
                            ...
                            <a className={cn(styles.noDecor)} href="https://www.linkedin.com/in/riccardo-spadondev/"><Linkedin className="ms-3" size={30}/></a>
